...
class TransientTokenControllerTest extends TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('troojaan\Passport\ApiTokenCookieFactory');
        ...
        $controller = new troojaan\Passport\Http\Controllers\TransientTokenController($cookieFactory);
