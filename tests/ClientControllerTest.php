...
class ClientControllerTest extends TestCase
{
    ...
    public function test_all_the_clients_for_the_current_user_can_be_retrieved()
    {
        ...
        $controller = new troojaan\Passport\Http\Controllers\ClientController(
    ...
    public function test_clients_can_be_stored()
    {
        ...
        $clients->shouldReceive('create')->once()->with(1, 'client name', 'http://localhost')->andReturn($client = new troojaan\Passport\Client);
    ...
    {
        $clients = Mockery::mock('troojaan\Passport\ClientRepository');
        $client = Mockery::mock('troojaan\Passport\Client');
        ...
        $clients->shouldReceive('update')->once()->with(
            Mockery::type('troojaan\Passport\Client'), 'client name', 'http://localhost'
        )->andReturn('response');
    ...
    public function test_clients_can_be_deleted()
    {
        ...
        $clients->shouldReceive('delete')->once()->with(
            Mockery::type('troojaan\Passport\Client')
        )->andReturn('response');
